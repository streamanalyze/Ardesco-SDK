...
static int power_mgmt_init(void)
{
	...
	/* Hardware controls charge current that is around 250 mA */

	/* Sets the charge current protection threshold to 300 mA. */
	err = adp536x_oc_chg_current_set(ADP536X_OC_CHG_THRESHOLD_300mA);
	if (err) {
